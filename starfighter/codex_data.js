...
const SFCodexData = (function () {
  ...
  const HOSTILE = [
    ...
    {
      id: 'bomber', designation: 'Zorgon Assault Bomber', shortName: 'Bomber',
      class: 'Heavy Bomber', faction: 'Hive Sigma', threatLevel: 4,
      glbKey: 'bomber', glbFile: 'Bomber_Leviathan Tick.glb', firstWave: 4,
      silhouette: 'Dense organic-metallic hull — layered chitin plating over a broad ventral bomb bay. Six articulated struts fold flat in cruise, deploy wide on approach. Bioluminescent amber veins pulse along the wing roots.',
      abilities: [
        { name: 'Proximity Bomb', kind: 'weapon', notes: 'Drops every ~6 s. Detonates in radius — splash damage to anything within range.' },
        { name: 'Heavy Hull', kind: 'tactic', notes: 'Roughly 2.5× Drone HP at the same sortie level.' },
        { name: 'EMP Resistance', kind: 'tactic', notes: 'Advanced shielding partially resists electromagnetic pulses. A direct EMP at close range still disables it — but a glancing pulse may not.' },
      ],
      vulnerabilities: [
        'Slow turn rate — easy to circle once committed to a bomb run.',
        'No active shields — sustained laser fire punches through.',
        'Bomb bay doors are exposed during release: a hit on the underside detonates loaded ordnance prematurely.',
        'EMP Pulse at close range disables weapons and engines.',
      ],
      backstory: 'Zorgon Assault Bombers represent a more advanced stage of Hive Sigma military technology than the standard drone wings. They do not engage fighters directly — their doctrine is to close on capital targets and saturate them with proximity ordnance. UEDF analysts believe they are grown rather than built, like all Hive craft, but from a more mature and resource-intensive biomass strain. They appear later in a campaign when the Hive has committed to a sustained assault rather than probing raids. The Rescue Shuttle and Medical Frigate fleets are their preferred soft targets.',
    },
    {
