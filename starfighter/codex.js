...
const SFCodex = (function () {
  ...
  function _buildOverlay() {
    ...
    _root.innerHTML = [
      ...
      '  <div id="sf-codex-list" style="overflow-y:auto;border:1px solid rgba(0,255,255,0.18);padding:8px;background:rgba(0,20,40,0.4)"></div>',
      '  <div id="sf-codex-detail" style="overflow-y:auto;border:1px solid rgba(0,255,255,0.18);padding:18px 22px;background:rgba(0,20,40,0.35)"></div>',
