...
class GameState {
    ...
    calculateDestinations(peg, card, player) {
                        ...
                        if (!peg.onFasttrack && path.length >= 2) {
                            ...
                            if (ftIndexInPath >= 0 && foundFtHole) {
                                ...
                                if (stepsAfterFt === 1) {
                                    ...
                                    // Center is position zero — any ft-* as penultimate hop qualifies
                                    if (!this.isPegOnHole('center', player.index) && !peg.hasExitedBullseye) {
                                        destinations.push({
                                            holeId: 'center',
                                            steps: steps,
        ...
        // Center is position zero — never "in front of" another peg.
